jQuery(document).ready(function () {
    ...
    $(".add_breadCrum").html('Forward to Surveyor')
    ...
    function verifier_land_init() {
        ...
        var datatable = $('#show_land_records_verifier').KTDatatable({
            ...
            columns: [{
                ...
                width: 100,
                template: function (row) {
                    return '<span class="kt-label-font-color-3 kt-font-bold">' + row.certificate_no + '</span>';
                },
            }, {
                field: 'status',
                title: 'Status',
            ...
            },
            {
                ...
                template: function (row) {
                    return '<div class="row action_btn_row">\
                                <a data-id="'+ row._id + '" data-comment="' + row.comment + '" data-comment3="' + row.comment3 + '" data-status="' + row.approvalStatus + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="view_verified_question" title="View Verified Details">\
                ...
                template: function (row) {
                    ...
                    ';
                        ...
                        return '<div class="row action_btn_row">\
                                ...
                                <a data-id="'+ row._id + '" data-userid="' + row.user_id + '" data-certificateno="' + row.certificate_no + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="approve_details" title="Approve Records">\
        ...
        $("#show_land_records_verifier").on("click", 'tbody #approve_details', function (e) {
            ...
            location.href = 'verifier_two_checklist.html?id=' + row + '&user=' + $(this).data('userid') + '&certi=' + $(this).data('certificateno')
        })
        ...
        $("#show_land_records_verifier").on("click", 'tbody #show_comment', function (e) {
            ...
            $("#preview_details_title").html('Reason of Survey for this Application')
        ...
        $("#show_land_records_verifier").on("click", 'tbody #edit_draft_application', function (e) {
            var row = $(this).data('id');
            location.href = 'verifier_one_checklist.html?id=' + row + '&user=' + $(this).data('userid') + '&certi=' + $(this).data('certificateno')
        })
