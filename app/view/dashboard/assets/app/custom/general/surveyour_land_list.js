    ...
    function verifier_land_init() {
        ...
        var datatable = $('#show_land_records_verifier').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: domain + '/listCommissionerLandRecords?approvalStatus=' + approvalStatus + '&hash=' + hash,
                        method: 'GET'
                    },
                },
                pageSize: 10,
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    return '<div class="row action_btn_row">\
                                <a data-id="'+ row._id + '" data-comment="' + row.comment + '" data-comment2="' + row.comment2 + '" data-fileHash1="' + filehash1 + '" data-fileName1="' + filename1 + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="view_verified_question" title="View Verified Details">\
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    ';
                    } else if (row.approvalStatus == 2 || row.approvalStatus == 7) {
                        return '<div class="row action_btn_row">\
                        <a data-id="'+ row._id + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="view_full_details" title="View Full Details">\
                            <i class="la la-eye"></i>\
                        </a>\
                        <a data-id="'+ row._id + '" data-comment="' + row.comment3 + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="show_comment" title="Show Comment">\
