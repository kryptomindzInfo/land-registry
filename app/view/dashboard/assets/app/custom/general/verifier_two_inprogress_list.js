        ...
        var datatable = $('#show_land_records_verifier').KTDatatable({
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    if (row.land_details.hasOwnProperty('extraDocs2')) {
                    ...
                    return '<div class="row action_btn_row">\
                                <a data-id="'+ row._id + '" data-comment="' + row.land_details.comment + '" data-comment2="' + row.land_details.comment2 + '" data-comment3="' + row.land_details.comment3 + '" data-comment4="' + row.land_details.comment4 + '" data-fileHash1="' + filehash1 + '" data-fileName1="' + filename1 + '" data-fileHash2="' + filehash2 + '" data-fileName2="' + filename2 + '" class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="view_verified_question" title="View Verified Details">\
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    return '<div class="row action_btn_row">\
                                ...
                                <a  data-id="'+ row.land_id + '" data-userid="' + row.land_user + '" data-certificateno="' + row.land_details.certificate_no + '" data-certificatetype="' + row.land_details.certificate_type + '"class="btn btn-clean btn-icon btn-sm btn-icon-md"  id="edit_draft_application" title="Edit Details">\
