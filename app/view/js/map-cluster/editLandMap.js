$(window).on("load", function () {
    ...
    function createPolygon(map) {
        ...
        var lat_lng_arr=lat_lng[0].split(", ")
            ...
            $("#area_as_per_marking").val(area.toFixed(4) + ' sq.m')
            document.getElementById('map_zoom').value = map.getZoom()
            // attachPolygonInfoWindow(createpolygon, triangleCoords)

            // function attachPolygonInfoWindow(polygon, data) {
            //     var infoWindow = new google.maps.InfoWindow();
            //     google.maps.event.addListener(polygon, 'mouseover', function (e) {
            //         infoWindow.setContent("Owner Name: " + data.owner_name + "<br> Mobile: " + data.owner_mobile);
            //         var latLng = e.latLng;
    ...
    function mapinit() {
        ...
        $('#long').change(function () {
            map.panTo({lat: parseFloat(document.getElementById('lat').value), lng: parseFloat(document.getElementById('long').value)})
            map.setZoom(20)
        })
