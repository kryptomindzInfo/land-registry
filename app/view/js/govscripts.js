            ...
            if ($("#file_hash").val() != '' && $("#file_name").val() != '') {
                ...
                var details = {
                    stepone: {
                        ...
                        'firstname': JSON.parse(sessionStorage.userData)[0].firstname,
                        'lastname': JSON.parse(sessionStorage.userData)[0].lastname,
                    ...
                    stepsix: {
                        'upload_title': uploaddetails.length > 0 ? uploaddetails : null
                    }
                }

                $.when($.post('/uploadGovLandRecords', details)).done(function (_res) {
                    if (_res.code == 200) {
